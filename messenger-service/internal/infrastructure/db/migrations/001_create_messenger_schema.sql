...
CREATE INDEX idx_participants_user_active ON conversation_participants(user_id, is_archived, deleted_at);
CREATE INDEX idx_participants_user_conv ON conversation_participants(user_id, conversation_id);
CREATE INDEX idx_participants_last_read_seq ON conversation_participants(conversation_id, user_id, last_read_seq);
CREATE INDEX idx_conversations_last_message ON conversations(last_message_at);
CREATE INDEX idx_conversations_last_message_id ON conversations(last_message_id);
CREATE INDEX idx_message_histories_message ON message_histories(message_id, edited_at);
CREATE INDEX idx_message_histories_editor ON message_histories(edited_by, edited_at);
