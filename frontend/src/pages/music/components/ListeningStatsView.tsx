    ...
    return (
        ...
        >
            <Stack direction="row" alignItems="center" spacing={1} mb={1}>
                ...
                <Typography sx={{ fontSize: 12, color: "text.secondary", fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.5 }}>
                    {label}
                </Typography>
            </Stack>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={0.5}>
                ...
                <Stack direction="row" spacing={1.5} alignItems="center">
                    <Stack direction="row" alignItems="center" spacing={0.4}>
                        <HeadphonesIcon sx={{ fontSize: 12, color: "text.disabled" }} />
                    ...
                    {skipRate > 0 && (
                        <Stack direction="row" alignItems="center" spacing={0.4}>
                            <SkipNextIcon sx={{ fontSize: 12, color: "text.disabled" }} />
                            <Typography sx={{ fontSize: 12, color: "text.disabled" }}>
                                {skipRate}%
                            </Typography>
                        </Stack>
            ...
            <LinearProgress
                ...
                sx={{
                    ...
                    "& .MuiLinearProgress-bar": {
                        bgcolor: completionRate >= 70 ? SP_GREEN : "text.disabled",
                        borderRadius: 3,
                    },
                }}
            />
    ...
    return (
        <Box>
            ...
            {isLoading ? (
                ...
                >
                    <HeadphonesIcon sx={{ fontSize: 48, color: "text.disabled", mb: 2 }} />
                ...
                <>
                    ...
                    {/* Genre breakdown */}
                    <Typography sx={{ fontSize: 14, fontWeight: 700, color: "text.secondary", textTransform: "uppercase", letterSpacing: 0.5, mb: 2 }}>
                        Tất cả thể loại
                    </Typography>
                    {dna.map((entry) => (
