...
const LoginLanding = () => (
    ...
    >
        ...
        <Box
            sx={{ display: "flex", flexDirection: "column", gap: 2, width: "100%", maxWidth: 420 }}
        >
    ...
    const handleFaceIdLogin = async () => {
        ...
        try {
            ...
            if (e.name === "NotAllowedError") {
                ...
                setFaceIdError(
                    e.message ?? "Đăng nhập bằng Face ID thất bại. Thiết bị có thể chưa đăng ký.",
                );
            }
        } finally {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {faceIdLoading ? "Đang xác thực..." : "Đăng nhập bằng Face ID"}
                    </Button>
