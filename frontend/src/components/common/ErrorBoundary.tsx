      ...
      return (
        <Box
          sx={(theme) => ({
            ...
            animation: "ebGradient 10s ease infinite",
        ...
        >
          ...
          <Box
            sx={(theme) => ({
              ...
              right: -80,
              pointerEvents: "none",
              animation: "ebBlob1 8s ease-in-out infinite",
              "@keyframes ebBlob1": {
          ...
          <Box
            sx={(theme) => ({
              ...
              left: -60,
              pointerEvents: "none",
              animation: "ebBlob2 10s ease-in-out infinite",
              "@keyframes ebBlob2": {
                "0%, 100%": { transform: "translate(0, 0) scale(1)" },
          ...
          <Box
            sx={(theme) => ({
              ...
              right: "10%",
              pointerEvents: "none",
              animation: "ebBlob3 12s ease-in-out infinite",
              "@keyframes ebBlob3": {
                "0%, 100%": { transform: "translate(0, 0) scale(1)" },
          ...
          <Box sx={{ position: "relative", display: "inline-flex" }}>
            ...
            <Box
              sx={(theme) => ({
                ...
                animation: "ebPing 2.4s ease-in-out infinite",
                "@keyframes ebPing": {
          ...
          <Box sx={{ textAlign: "center", maxWidth: 480 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              >
                Ứng dụng gặp sự cố không mong muốn. Bạn có thể thử tải lại hoặc
                quay về trang chủ.
              </Box>
              <Box
                component="span"
              ...
              >
                Ứng dụng gặp sự cố. Thử tải lại hoặc về trang chủ.
              </Box>
            </Typography>
            {errorMessage && (
              <Typography
