...
export interface WebSocketHandlers {
    ...
    onConversationUpdated?: (data: VersionedConversationEvent & { conversation: unknown }) => void;
    onParticipantUpdated?: (data: VersionedParticipantEvent & { participant: unknown }) => void;
    ...
    // Group call events
    onCallGroupRinging?: (data: unknown) => void;
    onCallGroupIncoming?: (data: unknown) => void;
    onCallGroupOngoing?: (data: unknown) => void;
    onCallGroupUnavailable?: (data: unknown) => void;
    onCallGroupStarted?: (data: unknown) => void;
    onCallGroupJoined?: (data: unknown) => void;
    onCallGroupState?: (data: unknown) => void;
    onCallGroupParticipantJoined?: (data: unknown) => void;
    onCallGroupParticipantLeft?: (data: unknown) => void;
    onCallMediaState?: (data: unknown) => void;
    onCallGroupLeft?: (data: unknown) => void;
    onCallGroupDeclined?: (data: unknown) => void;
    onCallGroupMissed?: (data: unknown) => void;
    onCallGroupFull?: (data: unknown) => void;
...
export class MessengerWebSocketService {
    ...
    private handleMessage(data: string) {
        try {
            ...
            if (message.type?.startsWith("call:")) {
                console.debug("[WS]", message.type, message.payload);
            }
            ...
            switch (message.type) {
                ...
                case "call:reconnect":
                    ...
                    break;
                case "call:group-ringing":
                    this.emit("onCallGroupRinging", message.payload);
                    break;
                case "call:group-incoming":
                    this.emit("onCallGroupIncoming", message.payload);
                    break;
                case "call:group-ongoing":
                    this.emit("onCallGroupOngoing", message.payload);
                    break;
                case "call:group-unavailable":
                    this.emit("onCallGroupUnavailable", message.payload);
                    break;
                case "call:group-started":
                    this.emit("onCallGroupStarted", message.payload);
                    break;
                case "call:group-joined":
                    this.emit("onCallGroupJoined", message.payload);
                    break;
                case "call:group-state":
                    this.emit("onCallGroupState", message.payload);
                    break;
                case "call:group-participant-joined":
                    this.emit("onCallGroupParticipantJoined", message.payload);
                    break;
                case "call:group-participant-left":
                    this.emit("onCallGroupParticipantLeft", message.payload);
                    break;
                case "call:media-state":
                    this.emit("onCallMediaState", message.payload);
                    break;
                case "call:group-left":
                    this.emit("onCallGroupLeft", message.payload);
                    break;
                case "call:group-declined":
                    this.emit("onCallGroupDeclined", message.payload);
                    break;
                case "call:group-missed":
                    this.emit("onCallGroupMissed", message.payload);
                    break;
                case "call:group-full":
                    this.emit("onCallGroupFull", message.payload);
                    break;
    ...
    private emit<K extends keyof WebSocketHandlers>(eventName: K, payload: unknown) {
        type HandlerPayload = Parameters<NonNullable<WebSocketHandlers[K]>>[0];
        const handler = this.handlers[eventName] as ((data: HandlerPayload) => void) | undefined;
