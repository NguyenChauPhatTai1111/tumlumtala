...
func NewClient(storageZone, apiKey, storageBaseURL, cdnBaseURL string) (*Client, error) {
	storageZone = strings.TrimSpace(storageZone)
	apiKey = strings.TrimSpace(apiKey)
	uploadBaseURL := strings.TrimRight(strings.TrimSpace(storageBaseURL), "/")
	baseURL := strings.TrimRight(strings.TrimSpace(cdnBaseURL), "/")
