...
func TestRegisterRoutesExposesCompleteMusicAPI(t *testing.T) {
	...
	expected := []string{
		...
		"GET /api/v1/music/search/artists",
		"GET /api/v1/music/search/playlists",
		"GET /api/v1/music/spotify/discovery/:section",
		"GET /api/v1/music/tracks/:track_id",
		"GET /api/v1/music/artists/:artist_id",
		"GET /api/v1/music/artists/:artist_id/discography",
		"GET /api/v1/music/albums/:album_id",
		"GET /api/v1/music/albums/:album_id/tracks",
