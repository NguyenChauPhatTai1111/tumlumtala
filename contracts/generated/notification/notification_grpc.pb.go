...
const (
	...
	NotificationService_ReplayDLQ_FullMethodName = "/notification.NotificationService/ReplayDLQ"
)
...
func (c *notificationServiceClient) ReplayDLQ(ctx context.Context, in *ReplayDLQRequest, opts ...grpc.CallOption) (*ReplayDLQResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReplayDLQResponse)
	err := c.cc.Invoke(ctx, NotificationService_ReplayDLQ_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNotificationServiceServer) ReplayDLQ(context.Context, *ReplayDLQRequest) (*ReplayDLQResponse, error) {
...
func _NotificationService_ReplayDLQ_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReplayDLQRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServiceServer).ReplayDLQ(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_ReplayDLQ_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).ReplayDLQ(ctx, req.(*ReplayDLQRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NotificationService_ReplayDLQ_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc/notification.proto",
}
